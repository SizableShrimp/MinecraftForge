package net.minecraftforge.fml.lifecycle;
...
//    private final ModLoadingState POST_CLIENT_SETUP = ModLoadingState.withInline("POST_CLIENT_SETUP", "SIDED_SETUP", ModLoadingPhase.LOAD, ml->RenderingRegistry.loadEntityRenderers(mc.getEntityRenderDispatcher()));
    ...
    private final ModLoadingState DONE = ModLoadingState.empty("DONE", "COMPLETE", ModLoadingPhase.DONE);
