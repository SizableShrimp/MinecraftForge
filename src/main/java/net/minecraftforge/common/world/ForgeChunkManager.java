...
public class ForgeChunkManager
{
    ...
    {
        ForcedChunksSavedData data = world.getDataStorage().get(ForcedChunksSavedData::new, "chunks");
          ...
          TicketType<TicketOwner<T>> type, Function<ForcedChunksSavedData, TicketTracker<T>> ticketGetter)
    {
        ...
        ForcedChunksSavedData saveData = world.getDataStorage().computeIfAbsent(ForcedChunksSavedData::new, "chunks");
