...
public class ForgeEventFactory
{
    ...
    @Nullable
    public static List<MobSpawnSettings.SpawnerData> getPotentialSpawns(LevelAccessor world, MobCategory type, BlockPos pos, List<MobSpawnSettings.SpawnerData> oldList)
    {
    ...
    public static boolean onProjectileImpact(AbstractArrow arrow, HitResult ray)
    {
        return MinecraftForge.EVENT_BUS.post(new ProjectileImpactEvent.Arrow(arrow, ray));
    }

    public static boolean onProjectileImpact(AbstractHurtingProjectile fireball, HitResult ray)
    {
        return MinecraftForge.EVENT_BUS.post(new ProjectileImpactEvent.Fireball(fireball, ray));
    }

    public static boolean onProjectileImpact(ThrowableProjectile throwable, HitResult ray)
    {
