...
public class BabyEntitySpawnEvent extends net.minecraftforge.eventbus.api.Event
{
    ...
    private AgableMob child;

    public BabyEntitySpawnEvent(Mob parentA, Mob parentB, @Nullable AgableMob proposedChild)
    {
    ...
    @Nullable
    public AgableMob getChild()
    {
        return child;
    }

    public void setChild(AgableMob proposedChild)
    {
        child = proposedChild;
    }
}
